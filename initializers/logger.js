...
module.exports = {
  ...
  initialize: function(api, next){
    ...
    api.log = function(action, message, severity){
      ...
      var logmessage = action + ': ' + message;
      var args = [ severity, logmessage ];
    ...
    api.log('log', 'starting actionhero', 'notice')
    api.log('log', 'Logger loaded. possible levels include: ', 'trace', logLevels);
